...
use Ecomm\News\Model\News as NewsModel;
use Ecomm\News\Model\ResourceModel\News\CollectionFactory;

abstract class MassAction extends News
{
    /**
     * @var Filter
     */
    ...
    /**
     * @param NewsModel $data
     * @return mixed
     */
    abstract protected function massAction(NewsModel $data);
    ...
    public function execute()
    {
        ...
        $redirectResult->setPath('newsadmin/news/index');
