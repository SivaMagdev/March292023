...
namespace Ecomm\LowStockNotification\Helper;
...
/**
 * Class Data
 * @package Ecomm\LowStockNotification\Helper
 */
class Data extends AbstractHelper
{
    ...
    const LOW_STOCK_SINGLE_ALERT_TEMPLATE_FILE =
                    'Ecomm_LowStockNotification::notifications/low_stock_single_alert.phtml';

    const LOW_STOCK_ALERT_TEMPLATE_FILE = 'Ecomm_LowStockNotification::notifications/low_stock_alert.phtml';
    ...
    public function notify($lowStockItems = [])
    {
        ...
        try {
            if ($this->isEnabled()) {
                ...
                $to_emails = explode(',', $this->emailRecipient());
                ...
                $transport = $this->transportBuilder
                    ...
                    ->setTemplateVars(['lowStockHtml' => $lowStockHtml])
