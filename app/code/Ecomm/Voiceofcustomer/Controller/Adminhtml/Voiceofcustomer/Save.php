...
class Save extends Voiceofcustomer
{
    /**
     * @var Manager
     */
    ...
    public function __construct(
        ...
        VoiceofcustomerInterfaceFactory $dataFactory,
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            try {
                ...
                $this->dataObjectHelper->populateWithArray($model, $data, VoiceofcustomerInterface::class);
                $this->dataRepository->save($model);
                $this->messageManager->addSuccessMessage(__('You saved this data.'));
                $this->_getSession()->setFormVoiceofcustomer(false);
            ...
            $this->_getSession()->setFormVoiceofcustomer($data);
