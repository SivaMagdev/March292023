...
class Delete extends Voiceofcustomer
{
    /**
    ...
    public function execute()
    {
        ...
        if ($dataId) {
            try {
                ...
                $resultRedirect->setPath('voiceofcustomeradmin/voiceofcustomer/index');
                return $resultRedirect;
            } catch (NoSuchEntityException $e) {
                $this->messageManager->addErrorMessage(__('The data no longer exists.'));
                return $resultRedirect->setPath('voiceofcustomeradmin/voiceofcustomer/index');
            } catch (LocalizedException $e) {
                $this->messageManager->addErrorMessage($e->getMessage());
                return $resultRedirect->setPath('voiceofcustomeradmin/voiceofcustomer/index', ['id' => $dataId]);
            } catch (\Exception $e) {
                $this->messageManager->addErrorMessage(__('There was a problem deleting the data'));
                return $resultRedirect->setPath('voiceofcustomeradmin/voiceofcustomer/edit', ['id' => $dataId]);
            }
        }
