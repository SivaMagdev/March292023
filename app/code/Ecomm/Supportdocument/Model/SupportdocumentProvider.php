...
class SupportdocumentProvider extends AbstractDataProvider
{
    /**
     * @var ResourceModel\Supportdocument\Collection
     */
    ...
    public function getData()
    {
        ...
        foreach ($items as $page) {
            ...
            if (isset($_data['attachment'])) {
                ...
                ).'supportdocument/tmp/attachment/'.$page->getAttachment();
