 ...
 *
 */
namespace Ecomm\Supportdocument\Ui\Component\Listing\Column;
...
class Profileimage extends Column
{
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            ) . 'supportdocument/tmp/attachment/';
            $baseImage = $this->assetRepo->getUrl('Ecomm_Supportdocument::images/noimage.jpg');
            $fieldName = $this->getData('name');
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item[$fieldName])) {
                    $item[$fieldName . '_src'] = $path . $item['attachment'];
                    $item[$fieldName . '_alt'] = 'Attachment';
                ...
                $item[$fieldName . '_link'] = $this->_backendUrl->getUrl(
                    "supportdocumentadmin/supportdocument/edit",
                    ['id' => $item['id']]
                );
            }
        }
