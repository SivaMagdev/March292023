...
use Ecomm\Supportdocument\Model\Supportdocument as SupportdocumentModel;
use Ecomm\Supportdocument\Model\ResourceModel\Supportdocument\CollectionFactory;

abstract class MassAction extends Supportdocument
{
    /**
     * @var Filter
     */
     ...
     * @param SupportdocumentRepositoryInterface $dataRepository
    ...
    /**
     * @param SupportdocumentModel $data
     * @return mixed
     */
    abstract protected function massAction(SupportdocumentModel $data);
    ...
    public function execute()
    {
        ...
        $redirectResult->setPath('supportdocumentadmin/supportdocument/index');
