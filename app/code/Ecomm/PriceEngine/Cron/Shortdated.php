...
class Shortdated
{
    ...
    public function execute()
    {
        ...
        //echo '<pre>Test'.print_r($_shortdated_price_collections->getData(),true).'</pre>';
        //exit();
        ...
        if($_shortdated_price_collections) {
            ...
            //echo 'shortdated_id: '.$shortdated_id.'<br />';
        ...
        if ($import > 0) {
            $this->logger->log('ERROR','Shortdated Price Updated successfully:',[$not_exists]);
        } else {
            $this->logger->log('ERROR','No Shortdated Price Updated:',[$not_exists]);
        }
