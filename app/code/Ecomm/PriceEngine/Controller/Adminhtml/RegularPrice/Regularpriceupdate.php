 ...
 */
class Regularpriceupdate extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($import > 0) {
            $this->messageManager->addSuccess(__('Regular Price Updated successfully.') . $not_exists);
        } else {
            $this->messageManager->addError(__('No Regular Price Updated.') . $not_exists);
        }
