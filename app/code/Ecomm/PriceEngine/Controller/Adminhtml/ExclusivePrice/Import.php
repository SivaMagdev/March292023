...
class Import extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Ecomm_PriceEngine::exclusiveprice_import');
        $resultPage->getConfig()->getTitle()->prepend(__('Import Exclusive Price'));
        return $resultPage;
    }
    ...
    public function downloadSampleAction()
    {
        ...
        $outputFile = $logDir . '/' . 'import' . '/' . 'exclusivepriceimport.csv';
