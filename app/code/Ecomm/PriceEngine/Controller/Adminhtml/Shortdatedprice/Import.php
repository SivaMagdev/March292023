...
class Import extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Ecomm_PriceEngine::shortdatedprice_import');
        $resultPage->getConfig()->getTitle()->prepend(__('Import Short Dated Price'));
        return $resultPage;
    }
    ...
    public function downloadSampleAction()
    {
        ...
        $outputFile = $logDir . '/' . 'import' . '/' . 'shortdatedpriceimport.csv';
