...
class ValidateCartItems implements ObserverInterface
{
    /**
            ...
            foreach($cartItems as $cartItem){
                ...
                if (!empty($customOptions)) {
                    ...
                    foreach($customOptions2 as $option) {
                        ...
                        foreach($values as $value) {
                            if($option_value == $value->getOptionTypeId()) {
                                ...
                                //$this->logger->info('Option Price :'.$custom_option_price);
                                //$this->logger->info('Option Title :'.$custom_option_title);
                    ...
                    if($delete_this_product == true) {
                        ...
                        //$this->logger->info('Item Price: '.$custom_option_price.' - Ordered Price: '.$cartItem->getPrice());
                        ...
                        if($custom_option_price != $cartItem->getPrice() && $delete_this_product == false) {
                            ...
                            //$customQuote = $this->checkoutSession->getQuote();
                    ...
                    if($group_price > 0){
                        ...
                        //$this->logger->info('Custom Price: ' . $item->getCustomPrice() . 'Item Price' . $item->getPrice());

                        if(($item->getCustomPrice() > 0) || ($item->getPrice() <= 0)){
                            //$this->logger->info('vci Item Id: ' . $item->getId() . 'deleted');
