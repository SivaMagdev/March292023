...
class Delete extends Resources
{
    /**
    ...
    public function execute()
    {
        ...
        if ($dataId) {
            try {
                ...
                $resultRedirect->setPath('resourcesadmin/resources/index');
                return $resultRedirect;
            } catch (NoSuchEntityException $e) {
                $this->messageManager->addErrorMessage(__('The data no longer exists.'));
                return $resultRedirect->setPath('resourcesadmin/resources/index');
            } catch (LocalizedException $e) {
                $this->messageManager->addErrorMessage($e->getMessage());
                return $resultRedirect->setPath('resourcesadmin/resources/index', ['id' => $dataId]);
            } catch (\Exception $e) {
                $this->messageManager->addErrorMessage(__('There was a problem deleting the data'));
                return $resultRedirect->setPath('resourcesadmin/resources/edit', ['id' => $dataId]);
            }
        }
