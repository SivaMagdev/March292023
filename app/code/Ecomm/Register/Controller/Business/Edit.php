 ...
 */
namespace Ecomm\Register\Controller\Business;
...
class Edit extends \Magento\Customer\Controller\AbstractAccount implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        $block = $resultPage->getLayout()->getBlock('business_edit');
        if ($block) {
        ...
        $resultPage->getConfig()->getTitle()->set(__('Business Information'));
        return $resultPage;
    }
}
