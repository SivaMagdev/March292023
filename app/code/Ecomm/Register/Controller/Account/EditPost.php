        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
            ...
            try {
            	...
            	if ($this->getRequest()->getParam('change_email')) {
		            ...
		            try {
		                $this->getAuthentication()->authenticate($this->session->getCustomerId(),
		                    $this->getRequest()->getPost('current_password')
		                );

		                $customer->setData('email', $this->getRequest()->getParam('email'));
		                $customer_data['email'] = $this->getRequest()->getParam('email');
