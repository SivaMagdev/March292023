 ...
 * Class Validate
 */
class ValidateDea extends Action implements HttpPostActionInterface, HttpGetActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        $dea_license_id = $this->getRequest()->getParam('dea_license_id');
