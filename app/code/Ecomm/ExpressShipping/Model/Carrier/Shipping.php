<?php
namespace Ecomm\ExpressShipping\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    private function getShippingPrice($request)
    {
        ...
        //echo '<pre>test'.print_r($request->getBaseSubtotalInclTax(), true).'</pre>'; exit();
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        if($has_cold_chain_product == 1 && $has_normal_product == 0){
            return false;
        }
