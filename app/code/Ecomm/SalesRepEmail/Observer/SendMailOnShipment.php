...
class SendMailOnShipment implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($contact_person_email != '' && filter_var($contact_person_email, FILTER_VALIDATE_EMAIL)) {
            ...
            $vars = [
                ...
                'comment' => $shipmentData->getCustomerNoteNotify() ? $shipmentData->getCustomerNote() : '',
            ...
            $this->dataHelper->sendShipmentMail($vars);
        }
    }
