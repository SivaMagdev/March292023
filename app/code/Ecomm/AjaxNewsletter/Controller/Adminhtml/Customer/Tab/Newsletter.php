 ...
 */
namespace Ecomm\AjaxNewsletter\Controller\Adminhtml\Customer\Tab;
...
class Newsletter extends \Magento\Customer\Block\Adminhtml\Edit\Tab\Newsletter
{
    ...
    public function initForm()
    {
        ...
        $fieldset = $form->addFieldset(
            'base_fieldset',
            [
                'legend' => __('Promotional Information'),
    ...
    private function isSingleWebsiteMode(): bool
    {
        ...
        $shareConfig = $objectManager->create('Magento\Customer\Model\Config\Share');
        

        return $this->isSingleStoreMode()
            || !($shareConfig->isGlobalScope())
    ...
    private function prepareFormSingleWebsite(Fieldset $fieldset, array $subscriptions): void
    {
        ...
        $checkboxElement = $fieldset->addField(
            ...
            'checkbox',
            [
                'label' => __('Subscribed to Promotion'),
    ...
    private function retrieveSubscriberData(CustomerInterface $customer, int $websiteId): array
    {
        ...
        $this->systemStore = $objectManager->create('Magento\Store\Model\System\Store');
