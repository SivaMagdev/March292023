 ...
 */
class ExclusivePriceActions extends Column
{
    /**
     * Url path
     */
    const URL_PATH_EDIT = 'ecomm_exclusiveprice/exclusiveprice/edit';
    const URL_PATH_DELETE = 'ecomm_exclusiveprice/exclusiveprice/delete';
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['exclusive_price_id'])) {
