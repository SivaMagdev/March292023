...
class ProcessResponseAction extends BaseAction
{
    ...
    {
        $this->oauthUtility->log_debug("processResponseAction: execute");
    ...
    {
        $this->oauthUtility->log_debug("processResponseAction: findUserEmail");
        if ($arr) {
    ...
    {
        $this->oauthUtility->log_debug("processResponseAction: validateUserInfoData");
    ...
    {
        $this->oauthUtility->log_debug("processResponseAction: setUserInfoResponse");
